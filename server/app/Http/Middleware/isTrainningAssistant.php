...
class isTrainningAssistant
{
    ...
    /**
     * Kiểm tra user vừa đăng nhập có phải là trợ lý đào tạo ? 
     */
    protected $auth;
    ...
    public function handle($request, Closure $next, $guard = null)
    {
        ...
        /**
         *  kiểm tra role là admin hoặc trợ lý đào tạo
         */
        if ( $role != IS_ADMIN && $role != IS_TRAINNING_ASSISTANT) {
