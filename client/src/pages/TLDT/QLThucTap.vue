          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              >
                <thead>
                  <tr role="row">
                    <th class="sorting_asc" aria-controls="sampleTable">STT</th>
                    <th class="sorting" aria-controls="sampleTable">Họ & Tên</th>
                    <th class="sorting" aria-controls="sampleTable">Đề tài</th>
                    <th class="sorting" aria-controls="sampleTable">Người HD</th>
                    <th class="sorting" aria-controls="sampleTable">Doanh nghiệp</th>
                    <th class="sorting" aria-controls="sampleTable">Điểm GVHD</th>
                    <th class="sorting" aria-controls="sampleTable">Điểm DN</th>
      ...
      table: [
        {
          ...
          last_name: "Hạnh",
          password: "Quản lý bán hàng",
          gender: "FGC - Techlution",
          email: "9",
          date_birth: "Phan Anh Phong",
          phone: "9"
        },
        {
          id: 2,
