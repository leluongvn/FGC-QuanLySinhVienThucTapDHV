            ...
            <div class="col-md-7">
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <div class="invalid-feedback">
                    <span v-if="!$v.user.id_student.required">Yêu cầu nhập Mã sinh viên!</span>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="invalid-feedback">
                    <span v-if="!$v.user.date_birth.required">Yêu cầu bạn nhập ngày sinh!</span>
                  </div>
                </div>
                <!--phone-->
                <div class="col-md-6">
            ...
            <div class="col-md-7">
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <div class="valid-feedback">Mã sinh viên hợp lệ!</div>
                  <div class="invalid-feedback">
                    <span v-if="!$v.userUpdate.id_student.required">Yêu cầu nhập Mã sinh viên!</span>
                    <!-- <span v-if="!$v.user.id_student.isUnique">Mã sinh viên đã tồn tại!</span> -->
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="valid-feedback">Ngày sinh hợp lệ!</div>
                  <div class="invalid-feedback">
                    <span v-if="!$v.userUpdate.date_birth.required">Yêu cầu bạn nhập ngày sinh!</span>
                  </div>
                </div>
                <!--phone-->
                <div class="col-md-6">
...
export default {
  ...
  methods: {
    ...
    delData(id) {
      ...
      this.$http
        .delete(
          "http://localhost:8088/FGC/FGC-Lumen-qlthuctap/apilumen01/public/api/student/" +
            id
        )
        .then(
